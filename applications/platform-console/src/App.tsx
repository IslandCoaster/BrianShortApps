    ...
    <main className="platform-console">
      <section className="hero">
        ...
        <p className="hero-copy">
          The administration interface for the BrianShortApps Engineering Platform.
        </p>
      </section>
      ...
      <section className="statement">
        ...
        <p>
          The Platform Console begins by surfacing the architecture, standards, and package
          ecosystem that every BrianShortApps application will inherit.
        </p>
      </section>
